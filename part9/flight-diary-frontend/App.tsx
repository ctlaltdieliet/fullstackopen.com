...
<table>
      <tr>
        ...
        <td><input type="date" id="date" name="date" value={date} onChange={event => setDate(event.target.value)} /></td>
      </tr>
      <tr>
        <td><strong>Visibility</strong></td>
        <td><input type="radio" onChange={() => setVisibility('great')} name="Visibility" />Great </td>
        <td><input type="radio" onChange={() => setVisibility('good')} name="Visibility" />Good </td>
        <td><input type="radio" onChange={() => setVisibility('ok')} name="Visibility" />OK </td>
        <td><input type="radio" onChange={() => setVisibility('poor')} name="Visibility"  />Poor </td>        
      </tr>
      <tr>
        <td><strong>Weather</strong></td>
        <td><input type="radio" onChange={() => setWeather('sunny')} name="Weather" />Sunny </td>
        <td><input type="radio" onChange={() => setWeather('rainy')} name="Weather" />Rainy </td>
        <td><input type="radio" onChange={() => setWeather('cloudy')} name="Weather" />Cloudy </td>
        <td><input type="radio" onChange={() => setWeather('stormy')} name="Weather" />Stormy </td>
        <td><input type="radio" onChange={() => setWeather('windy')} name="Weather" />Windy </td>
